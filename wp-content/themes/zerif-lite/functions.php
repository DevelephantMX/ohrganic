...
function woo_add_custom_general_fields() {
  ...
  woocommerce_wp_text_input(
  	array(
  		'id'          => '_num_pedimento',
  		'label'       => __( 'Num. de pedimento', 'woocommerce' ),
  		'placeholder' => 'num. pedimento',
  		'desc_tip'    => 'true',
  		'description' => __( 'Ingresa el num. de pedimento.', 'woocommerce' )
  	)
  );
  woocommerce_wp_text_input(
  	array(
  		...
  		'desc_tip'    => 'true',
  		'description' => __( 'Ingresa la fecha.', 'woocommerce' )
  	)
  );
  woocommerce_wp_text_input(
  	array(
  		'id'          => '_aduana',
  		'label'       => __( 'Aduana', 'woocommerce' ),
  		'placeholder' => 'aduana',
  		'desc_tip'    => 'true',
  		'description' => __( 'Ingresa la aduana.', 'woocommerce' )
  	)
  );
  echo '</div>';
...
function woo_add_custom_general_fields_save( $post_id ){
	...
	// Text Field
	$woocommerce_text_field = $_POST['_num_pedimento'];
	if( !empty( $woocommerce_text_field ) )
		update_post_meta( $post_id, '_num_pedimento', esc_attr( $woocommerce_text_field ) );
		update_post_meta( $post_id, '_fecha', esc_attr( $woocommerce_text_field ) );
		update_post_meta( $post_id, '_aduana', esc_attr( $woocommerce_text_field ) );
